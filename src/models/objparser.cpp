...
bool ObjParser::parse(const std::string& filename) {
  ...
  if ( ifstream.is_open() ) {
	  ...
	  std::cerr << "ObjParser::parse: Unable to open " << filename << "." << std::endl;
	  return false;
  }
}

bool ObjParser::parse(std::istream& istream) {
  std::string line;
    ...
    if (stringstream.eof()) {
      ...
      if (keyword == "v") {
        ...
        if (!stringstream || !stringstream.eof() || !std::isspace(whitespace_v_x) || !std::isspace(whitespace_x_y) || !std::isspace(whitespace_y_z)) {
          error(line_number, "parse error");
          return false;
        }
        ++number_of_geometric_vertices;
        geometric_vertex(x, y, z);
      }
      ...
      // face (f)
        ...
        if (std::isspace(stringstream.peek())) {
          ...
          if (((v1 < int(-number_of_geometric_vertices)) || (-1 < v1)) && ((v1 < 1) || (int(number_of_geometric_vertices) < v1))
           || ((v2 < int(-number_of_geometric_vertices)) || (-1 < v2)) && ((v2 < 1) || (int(number_of_geometric_vertices) < v2))
           || ((v3 < int(-number_of_geometric_vertices)) || (-1 < v3)) && ((v3 < 1) || (int(number_of_geometric_vertices) < v3))) {
            error(line_number, "index out of bounds");
            return false;
          }
          ...
          if (stringstream.eof()) {
            ++number_of_faces;
            triangular_face_geometric_vertices(v1, v2, v3);
          }
          else {
            int v4;
            stringstream >> v4;
            ...
            if (((v4 < int(-number_of_geometric_vertices)) || (-1 < v4)) && ((v4 < 1) || (int(number_of_geometric_vertices) < v4))) {
              error(line_number, "index out of bounds");
              return false;
            }
            if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
            ...
            if (stringstream.eof()) {
              ...
              if (flags_ & TRIANGULATE_FACES) {
                triangular_face_geometric_vertices(v1, v2, v3);
                triangular_face_geometric_vertices(v1, v3, v4);
              }
              else {
                quadrilateral_face_geometric_vertices(v1, v2, v3, v4);
              }
            }
            else {
              if (flags_ & TRIANGULATE_FACES) {
                ...
                do {
                  ...
                  if (stringstream && std::isspace(whitespace_v_v)) {
                    if (((v < int(-number_of_geometric_vertices)) || (-1 < v)) && ((v < 1) || (int(number_of_geometric_vertices) < v))) {
                      error(line_number, "index out of bounds");
                      return false;
                    }
                    if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
                    ...
                    triangular_face_geometric_vertices(v1, v_previous, v);
                    v_previous = v;
                  }
                }
                ...
                polygonal_face_geometric_vertices_begin(v1, v2, v3);
                polygonal_face_geometric_vertices_vertex(v4);
                do {
                  int v;
                  stringstream >> v;
                  char whitespace_v_v = ' ';
                  ...
                  if (stringstream && std::isspace(whitespace_v_v)) {
                    ...
                    polygonal_face_geometric_vertices_vertex(v);
                  }
                }
                while (stringstream && !stringstream.eof());
                if (!stringstream || !stringstream.eof()) {
                ...
                ++number_of_faces;
                polygonal_face_geometric_vertices_end();
              }
            }
          }
        }
          ...
          if (stringstream.peek() != '/') {
            ...
            if (std::isspace(stringstream.peek())) {
              ...
              if (((v1 < int(-number_of_geometric_vertices)) || (-1 < v1)) && ((v1 < 1) || (int(number_of_geometric_vertices) < v1))
               || ((vt1 < -int(number_of_texture_vertices)) || (-1 < vt1)) && ((vt1 < 1) || (int(number_of_texture_vertices) < vt1))
               || ((v2 < int(-number_of_geometric_vertices)) || (-1 < v2)) && ((v2 < 1) || (int(number_of_geometric_vertices) < v2))
               || ((vt2 < -int(number_of_texture_vertices)) || (-1 < vt2)) && ((vt2 < 1) || (int(number_of_texture_vertices) < vt2))
               || ((v3 < int(-number_of_geometric_vertices)) || (-1 < v3)) && ((v3 < 1) || (int(number_of_geometric_vertices) < v3))
               || ((vt3 < -int(number_of_texture_vertices)) || (-1 < vt3)) && ((vt3 < 1) || (int(number_of_texture_vertices) < vt3))) {
                error(line_number, "index out of bounds");
                return false;
              }
              if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
              ...
              if (stringstream.eof()) {
                ++number_of_faces;
                triangular_face_geometric_vertices_texture_vertices(v1, vt1, v2, vt2, v3, vt3);
              }
              else {
                int v4, vt4;
                char slash_v4_vt4;
                ...
                if (((v4 < int(-number_of_geometric_vertices)) || (-1 < v4)) && ((v4 < 1) || (int(number_of_geometric_vertices) < v4))
                || ((vt4 < -int(number_of_texture_vertices)) || (-1 < vt4)) && ((vt4 < 1) || (int(number_of_texture_vertices) < vt4))) {
                  error(line_number, "index out of bounds");
                  return false;
                }
                if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
                ...
                if (stringstream.eof()) {
                  ...
                  if (flags_ & TRIANGULATE_FACES) {
                    triangular_face_geometric_vertices_texture_vertices(v1, vt1, v2, vt2, v3, vt3);
                    triangular_face_geometric_vertices_texture_vertices(v1, vt1, v3, vt3, v4, vt4);
                  }
                  else {
                    quadrilateral_face_geometric_vertices_texture_vertices(v1, vt1, v2, vt2, v3, vt3, v4, vt4);
                  }
                }
                else {
                  if (flags_ & TRIANGULATE_FACES) {
                    ...
                    int v_previous = v4, vt_previous = vt4;
                    do {
                      int v, vt;
                      ...
                      if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && std::isspace(whitespace_vt_v)) {
                        if (((v < int(-number_of_geometric_vertices)) || (-1 < v)) && ((v < 1) || (int(number_of_geometric_vertices) < v))
                        || ((vt < -int(number_of_texture_vertices)) || (-1 < vt)) && ((vt < 1) || (int(number_of_texture_vertices) < vt))) {
                          error(line_number, "index out of bounds");
                          return false;
                        }
                        if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
                        ...
                        triangular_face_geometric_vertices_texture_vertices(v1, vt1, v_previous, vt_previous, v, vt);
                    ...
                    polygonal_face_geometric_vertices_texture_vertices_begin(v1, vt1, v2, vt2, v3, vt3);
                    polygonal_face_geometric_vertices_texture_vertices_vertex(v4, vt4);
                    do {
                      int v, vt;
                      char slash_geometric_vertices_texture_vertices;
                      stringstream >> v >> slash_geometric_vertices_texture_vertices >> vt;
                      ...
                      if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && std::isspace(whitespace_vt_v)) {
                        ...
                        polygonal_face_geometric_vertices_texture_vertices_vertex(v, vt);
                      }
                    }
                    while (stringstream && !stringstream.eof());
                    if (!stringstream || !stringstream.eof()) {
                    ...
                    ++number_of_faces;
                    polygonal_face_geometric_vertices_texture_vertices_end();
                  }
                }
              }
            }
              ...
              if (((v1 < int(-number_of_geometric_vertices)) || (-1 < v1)) && ((v1 < 1) || (int(number_of_geometric_vertices) < v1))
               || ((vt1 < -int(number_of_texture_vertices)) || (-1 < vt1)) && ((vt1 < 1) || (int(number_of_texture_vertices) < vt1))
               || ((vn1 < -int(number_of_vertex_normals)) || (-1 < vn1)) && ((vn1 < 1) || (int(number_of_vertex_normals) < vn1))
               || ((v2 < int(-number_of_geometric_vertices)) || (-1 < v2)) && ((v2 < 1) || (int(number_of_geometric_vertices) < v2))
               || ((vt2 < -int(number_of_texture_vertices)) || (-1 < vt2)) && ((vt2 < 1) || (int(number_of_texture_vertices) < vt2))
               || ((vn2 < -int(number_of_vertex_normals)) || (-1 < vn2)) && ((vn2 < 1) || (int(number_of_vertex_normals) < vn2))
               || ((v3 < int(-number_of_geometric_vertices)) || (-1 < v3)) && ((v3 < 1) || (int(number_of_geometric_vertices) < v3))
               || ((vt3 < -int(number_of_texture_vertices)) || (-1 < vt3)) && ((vt3 < 1) || (int(number_of_texture_vertices) < vt3))
               || ((vn3 < -int(number_of_vertex_normals)) || (-1 < vn3)) && ((vn3 < 1) || (int(number_of_vertex_normals) < vn3))) {
                error(line_number, "index out of bounds");
                return false;
              }
              if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
              ...
              if (stringstream.eof()) {
                ++number_of_faces;
                triangular_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v2, vt2, vn2, v3, vt3, vn3);
              }
              else {
                int v4, vt4, vn4;
                ...
                if (((v4 < int(-number_of_geometric_vertices)) || (-1 < v4)) && ((v4 < 1) || (int(number_of_geometric_vertices) < v4))
                 || ((vt4 < -int(number_of_texture_vertices)) || (-1 < vt4)) && ((vt4 < 1) || (int(number_of_texture_vertices) < vt4))
                 || ((vn4 < -int(number_of_vertex_normals)) || (-1 < vn4)) && ((vn4 < 1) || (int(number_of_vertex_normals) < vn4))) {
                  error(line_number, "index out of bounds");
                  return false;
                }
                if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
                ...
                if (stringstream.eof()) {
                  ...
                  if (flags_ & TRIANGULATE_FACES) {
                    triangular_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v2, vt2, vn2, v3, vt3, vn3);
                    triangular_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v3, vt3, vn3, v4, vt4, vn4);
                  }
                  else {
                    quadrilateral_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v2, vt2, vn2, v3, vt3, vn3, v4, vt4, vn4);
                  }
                }
                else {
                  if (flags_ & TRIANGULATE_FACES) {
                    triangular_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v2, vt2, vn2, v3, vt3, vn3);
                    triangular_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v3, vt3, vn3, v4, vt4, vn4);
                    int v_previous = v4, vt_previous = vt4, vn_previous = vn4;
                    do {
                      int v, vt, vn;
                      ...
                      if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && (slash_vt_vn == '/') && std::isspace(whitespace_vn_v)) {
                        if (((v < int(-number_of_geometric_vertices)) || (-1 < v)) && ((v < 1) || (int(number_of_geometric_vertices) < v))
                        || ((vt < -int(number_of_texture_vertices)) || (-1 < vt)) && ((vt < 1) || (int(number_of_texture_vertices) < vt))
                        || ((vn < -int(number_of_vertex_normals)) || (-1 < vn)) && ((vn < 1) || (int(number_of_vertex_normals) < vn))) {
                          error(line_number, "index out of bounds");
                          return false;
                        }
                        if (flags_ & TRANSLATE_NEGATIVE_INDICES) {
                        ...
                        triangular_face_geometric_vertices_texture_vertices_vertex_normals(v1, vt1, vn1, v_previous, vt_previous, vn_previous, v, vt, vn);
                    ...
                    polygonal_face_geometric_vertices_texture_vertices_vertex_normals_begin(v1, vt1, vn1, v2, vt2, vn2, v3, vt3, vn3);
                    polygonal_face_geometric_vertices_texture_vertices_vertex_normals_vertex(v4, vt4, vn4);
                    do {
                      int v, vt, vn;
                      char slash_geometric_vertices_texture_vertices, slash_vt_vn;
                      stringstream >> v >> slash_geometric_vertices_texture_vertices >> vt >> slash_vt_vn >> vn;
                      ...
                      if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && (slash_vt_vn == '/') && std::isspace(whitespace_vn_v)) {
                        ...
                        polygonal_face_geometric_vertices_texture_vertices_vertex_normals_vertex(v, vt, vn);
                      }
                    }
                    while (stringstream && !stringstream.eof());
                    if (!stringstream || !stringstream.eof()) {
                    ...
                    ++number_of_faces;
                    polygonal_face_geometric_vertices_texture_vertices_vertex_normals_end();
                  }
                }
              }
            }
            ...
            if (stringstream.eof()) {
              ++number_of_faces;
              triangular_face_geometric_vertices_vertex_normals(v1, vn1, v2, vn2, v3, vn3);
            }
            else {
              int v4, vn4;
              char slash_v4_vt4, slash_vt4_vn4;
              ...
              if (stringstream.eof()) {
                ...
                if (flags_ & TRIANGULATE_FACES) {
                  triangular_face_geometric_vertices_vertex_normals(v1, vn1, v2, vn2, v3, vn3);
                  triangular_face_geometric_vertices_vertex_normals(v1, vn1, v3, vn3, v4, vn4);
                }
                else {
                  quadrilateral_face_geometric_vertices_vertex_normals(v1, vn1, v2, vn2, v3, vn3, v4, vn4);
                }
              }
              else {
                if (flags_ & TRIANGULATE_FACES) {
                  triangular_face_geometric_vertices_vertex_normals(v1, vn1, v2, vn2, v3, vn3);
                  triangular_face_geometric_vertices_vertex_normals(v1, vn1, v3, vn3, v4, vn4);
                  int v_previous = v4, vn_previous = vn4;
                  do {
                    int v, vn;
                    char slash_geometric_vertices_texture_vertices, slash_vt_vn;
                    ...
                    if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && (slash_vt_vn == '/') && std::isspace(whitespace_vn_v)) {
                      ...
                      triangular_face_geometric_vertices_vertex_normals(v1, vn1, v_previous, vn_previous, v, vn);
                  ...
                  polygonal_face_geometric_vertices_vertex_normals_begin(v1, vn1, v2, vn2, v3, vn3);
                  polygonal_face_geometric_vertices_vertex_normals_vertex(v4, vn4);
                  do {
                    int v, vn;
                    char slash_geometric_vertices_texture_vertices, slash_vt_vn;
                    stringstream >> v >> slash_geometric_vertices_texture_vertices >> slash_vt_vn >> vn;
                    ...
                    if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && (slash_vt_vn == '/') && std::isspace(whitespace_vn_v)) {
                      ...
                      polygonal_face_geometric_vertices_vertex_normals_vertex(v, vn);
                    }
                  }
                  while (stringstream && !stringstream.eof());
                  if (!stringstream || !stringstream.eof()) {
                  ...
                  ++number_of_faces;
                  polygonal_face_geometric_vertices_vertex_normals_end();
                }
              }
            }
          }
      ...
      // object name (o)
        ...
        stringstream >> whitespace_mtllib_object_name >> std::ws >> object >> std::ws;
      ...
      // material name (usemtl)
        ...
        stringstream >> whitespace_mtllib_material_name >> std::ws >> material >> std::ws;
